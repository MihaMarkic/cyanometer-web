...
namespace Cyanometer.Web.Utilities
{
    public class Calculator
    {
        ...
        private readonly NearestColorCalculator colorCalculator;
        ...
        public Calculator(NearestColorCalculator colorCalculator)
        {
            this.colorCalculator = colorCalculator;
            colors = ColorValues.Select(c => Color.FromHex(c)).ToArray();
        ...
        public GetBluenessIndexResult GetBluenessIndexTopPixels(IList<Color> image, int pixelsCount, int orientation)
        {
            ...
            return new GetBluenessIndexResult(
                ...
                indexes: result.ToImmutableArray()
            );
        }
    }
}
